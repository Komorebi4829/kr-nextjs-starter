export const FAQS_EN = [
  ...
  {
    title: "Why choose our Nextjs Landing Starter?",
    content:
  ...
  },
  {
    ...
    content:
      "We accept paid custom development of landing pages. Please contact us via email at kentriver4829@gmail.com or Twitter @kentkomorebi.",
  },
  {
  ...
  },
  {
    ...
    content:
      "If you encounter any issues while using the template, please contact us via Twitter @kentkomorebi.",
  },
];
...
export const FAQS_ZH = [
  ...
  },
  {
    title: "你们提供定制服务吗？",
    content:
      "我们接受落地页的定制开发服务。请通过电子邮件kentriver4829@gmail.com或Twitter @kentkomorebi与我们联系。",
  },
  {
    title: "使用这个模板有任何限制吗？",
    content:
  ...
  },
  {
    ...
    content:
      "如果你在使用模板时遇到任何问题，请通过Twitter @kentkomorebi 与我们联系。",
  },
];
...
export const FAQS_JA = [
  ...
  },
  {
    ...
    content:
      "有料のランディングページのカスタム開発を受け付けています。メールkentriver4829@gmail.comまたはTwitter @kentkomorebiでお問い合わせください。",
  },
  {
  ...
  },
  {
    ...
    content:
      "テンプレートの使用中に問題が発生した場合は、Twitter @kentkomorebiでお問い合わせください。",
  },
];
...
export const FAQS_AR = [
  ...
  },
  {
    ...
    content:
      "نحن نقبل التطوير المخصص المدفوع لصفحات الهبوط. يرجى التواصل معنا عبر البريد الإلكتروني على kentriver4829@gmail.com أو تويتر @kentkomorebi.",
  },
  {
  ...
  },
  {
    ...
    content:
      "إذا واجهت أي مشكلات أثناء استخدام القالب، فيرجى التواصل معنا عبر تويتر @kentkomorebi.",
  },
];
...
export const FAQS_ES = [
  ...
  },
  {
    ...
    content:
      "Aceptamos el desarrollo personalizado de páginas de destino a pedido. Por favor, contáctanos por correo electrónico a kentriver4829@gmail.com o en Twitter @kentkomorebi.",
  },
  {
  ...
  },
  {
    ...
    content:
      "Si encuentras problemas mientras usas la plantilla, comunícate con nosotros a través de Twitter @kentkomorebi.",
  },
];
...
export const FAQS_RU = [
  ...
  },
  {
    ...
    content:
      "Мы принимаем заказные разработки целевых страниц. Пожалуйста, свяжитесь с нами по электронной почте kentriver4829@gmail.com или в Twitter @kentkomorebi.",
  },
  {
  ...
  },
  {
    ...
    content:
      "Если вы столкнетесь с какими-либо проблемами при использовании шаблона, пожалуйста, свяжитесь с нами через Twitter @kentkomorebi.",
  },
];
