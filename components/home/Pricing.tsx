  ...
  return (
    ...
    >
      <div className="flex flex-col text-center max-w-xl">
        ...
        <h3 className="text-4xl font-medium tracking-tight mt-2 animate-fade-in [animation-delay:200ms]">
          {locale.title2}
        </h3>
        <Spacer y={4} />
        <p className="text-large text-default-500 animate-fade-in [animation-delay:400ms]">{locale.description}</p>
      </div>
      <Spacer y={8} />
